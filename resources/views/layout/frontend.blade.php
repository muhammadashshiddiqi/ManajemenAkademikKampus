	...
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>{{ config('kampus.title') }}</title>
	  			...
	  			<div class="container">
			  		<div class="row">
			  			<div class="col-lg-12 col-sm-12 col-12 header-top-right no-padding">
			  				<marquee behavior="scroll" direction="left">{{ config('kampus.header_info') }}</marquee>
			  			</div>
			  		</div>			  					
	  			</div>
				</div>
		    <div class="container main-menu" style="border-bottom:unset;">
